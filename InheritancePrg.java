...
class InheritancePrg //main class
{
	//main method
	public static void main(String[] args)
	{
		//object creation
		Manager m=new Manager(767666,"Sulmanulla","Dubai UAE",0076767,859000.00);
		m.calculateSalary();
		m.calculateTransportAllowance();

		Trainee t=new Trainee(973977,"Amulya","Bangalore India",9739771,34000.00);
		t.calculateSalary();
